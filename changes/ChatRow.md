...
|---|---|---|---|---|
| Default (unpinned) | ⚠ pending | — | bg `Surface/Card`, border `1px semi-transparent Stroke/Border` (45% mix), radius `lg 8px`, height `2.75rem` (44px), padding `0 .75rem`, `font .875rem/500`, ghost shadow at rest; checkbox slot `.cbx` **hidden** by default | layout: `flex; gap:.75rem; padding:0 .75rem; align-items:center` |
