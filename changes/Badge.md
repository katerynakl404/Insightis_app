...
Accessibility:
  ...
  ✓ Primary text vs bg — dark #2FA29B (Brand-400) on #0A1A1F (Brand-900) = 5.77:1 (matched margin in dark)
  ✓ Secondary text vs bg — light #334155 / #F8FAFC = 10.66:1 (now aligned with Body chip)
  ✓ Secondary text vs bg — dark #F4F4F5 / #2A2834 = 12.36:1
